...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'juba_juba', 'juba', self.gf('mezzanine.core.fields.HtmlField')(null=True))

    def backwards(self, orm):

        # Changing field 'Link.link'
        db.alter_column(u'juba_juba', u'juba', self.gf(u'mezzanine.core.fields.HtmlField')(default=''))
    ...
    models = {
        u'juba.juba': {
            ...
            'juba': ('mezzanine.core.fields.HtmlField', [], {'max_length': '200', 'null': 'True'}),
